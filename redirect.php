...
<html lang="it">
  ...
  <body style=" font-family:'Open Sans',X-LocaleSpecific-Light,'Open Sans',X-LocaleSpecific,sans-serif;">
    ...
    <div style="background-image:-webkit-linear-gradient(bottom, #FFFFFF 0%, #AACFEF 100%); height:250px;">
    	<div style="width:430px; margin:auto; padding-top:5%;"><a href="home.html"><img src="LIBRAY.png" alt="logo" style="width:430px;"></a></div>
	...
	<div style="border-radius: 15px;
                ...
                padding-left:1%;
                padding-right:1%;">
				<h1 align="center">OPS...</h1> <h4 align="center"> Non hai effettuato il Login o non ti sei Registrato! <br> Clicca <a href="home.php">QUI</a> per tornare alla home o clicca <a href="Reg.php">QUI</a> per registrarti. </h4>
		


</div>
	 <div style="margin-top:14%;"><nav class="navbar navbar-default" style="background-color:white;">
